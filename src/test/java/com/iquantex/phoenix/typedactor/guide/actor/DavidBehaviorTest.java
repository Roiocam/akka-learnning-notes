...
public class DavidBehaviorTest {
     ...
     * {@link com.iquantex.phoenix.typedactor.guide.protocol.HelloResponse}</p>
     * <p>2. 演示了改变Actor行为的能力,Actor接受两次 {@link com.iquantex.phoenix.typedactor.guide.protocol.HelloResponse}
     * 之后，不会再处理该信息，这是由 {@link DavidBehavior#wontHandleAnyMore(HelloResponse)} 的逻辑中定义，用了 {@link
     * Behaviors#empty()} 实现不处理</p>
     *
