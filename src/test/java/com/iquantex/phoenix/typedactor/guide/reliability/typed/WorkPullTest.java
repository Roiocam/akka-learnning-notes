...
public class WorkPullTest {
    ...
    public void test() throws InterruptedException {
        ActorRef<ImgConvertMessage> consumer1 =
                testKit.spawn(ImageConverterActor.create(), "consumer-1");
        ActorRef<ImgConvertMessage> consumer2 =
                testKit.spawn(ImageConverterActor.create(), "consumer-2");
        ActorRef<ImgConvertMessage> consumer3 =
                testKit.spawn(ImageConverterActor.create(), "consumer-3");
