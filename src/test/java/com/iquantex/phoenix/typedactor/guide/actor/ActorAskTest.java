...
public class ActorAskTest {
     ...
     * DavidBehavior}，在子Actor启动后，父 Actor 向子Actor 发送 {@link
     * com.iquantex.phoenix.typedactor.guide.actor.DavidBehavior.SayHello} 消息
     *
     ...
     * 的能力，以及 Actor 接受命令后向子Actor发起{@link akka.actor.typed.javadsl.ActorContext#ask(Class,
     * RecipientRef, Duration, Function, Function2)}的能力
     *
     * @throws InterruptedException
     */
    @Test
